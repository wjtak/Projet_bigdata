...
class Application(tk.Tk):
    ...
    def update_bdd(self):        
        ...
        new_df.loc[len(new_df)] = [self.date, self.product_ID, self.operation_qt, self.stock, self.operation_type]
    ...
    def replenishment(self):
        ...
        if self.validate_quantity_operation(operation_qt):
            ...
            mssg = f"replenishment {self.operation_qt} into product \"{self.product_ID}\" at {self.date} | New Available stock = {self.stock}"
            print(mssg)
            self.update_bdd()
            self.create_second_window()
    ...
    def sales(self):
        ...
        if self.validate_quantity_operation(operation_qt):
            ...
            mssg = f"Selling \"{self.operation_qt}\" of product \"{self.product_ID}\" at \"{self.date}\" | New Available stock = \"{self.stock}\""
            print(mssg)
            self.update_bdd()
            self.create_second_window()
